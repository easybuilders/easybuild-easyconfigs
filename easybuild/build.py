...
def add_build_options(parser):
    ...
    parser.add_option("--sequential", action="store_true", default=False,
            help="specify this option if you want to prevent parallel build")
    parser.add_option("--regtest-output-dir", help="set output directory for test-run")
    parser.add_option("--aggregate-regtest", help="collect all the xmls inside the given directory and generate a single file")
