...
class NetCDF4(PythonPackageModule):
    ...
    def make_install(self):
        ...
        cmd = "export HDF5_DIR=$SOFTROOTHDF5; export NETCDF4_DIR=$SOFTROOTNETCDF; python setup.py install --prefix=%s %s" \
            % (self.installdir, self.getcfg('installopts'))
        run_cmd(cmd, log_all=True, simple=True)
