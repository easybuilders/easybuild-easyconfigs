    ...
    def build_step(self):
        ...
        try:
            ...
            if not comm:
                ...
                (out, _) = run_cmd("mpirun -np 2 -H localhost ./EXE/xtc_CsameF77", log_all=True, simple=False)
                ...
                if not notregexp.search(out):
                    ...
                    if ec == 0:
                        ...
                        (out, _) = run_cmd("mpirun -np 2 -H localhost ./EXE/xtc_UseMpich", log_all=True, simple=False)
