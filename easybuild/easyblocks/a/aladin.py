...
class EB_ALADIN(EasyBlock):
    ...
    def configure_step(self):
        ...
        lapacklib = os.path.join(os.getenv('LAPACK_LIB_DIR'), os.getenv('LAPACK_STATIC_LIBS').split(',')[0])
        blaslib = os.path.join(os.getenv('LAPACK_LIB_DIR'), os.getenv('BLAS_STATIC_LIBS').split(',')[0])
