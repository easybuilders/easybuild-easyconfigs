...
class EasyConfigTest(TestCase):
    ...
    def test_pr_sanity_check_paths(self):
        ...
        whitelist = ['BuildEnv', 'CargoPythonPackage', 'CMakePythonPackage', 'ConfigureMakePythonPackage',
                     'CrayToolchain', 'GoPackage', 'JuliaBundle', 'ModuleRC', 'PerlBundle', 'PythonBundle',
                     'PythonPackage', 'Toolchain']
